...
function loadFsEvents() {
    ...
    return (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespaceDefault(require(t)); }); })(moduleName)
        .then(namespace => {
...
function normalizeOutputOptions(config, inputOptions, unsetInputOptions) {
    ...
    const outputOptions = {
        ...
        chunkHashLength: (_c = config.chunkHashLength) !== null && _c !== void 0 ? _c : 8,
        compact,
        dir: getDir(config, file),
        dynamicImportFunction: getDynamicImportFunction(config, inputOptions),
        entryFileNames: getEntryFileNames(config, unsetOptions),
        esModule: (_d = config.esModule) !== null && _d !== void 0 ? _d : true,
        exports: getExports(config, unsetOptions),
        extend: config.extend || false,
        externalLiveBindings: (_e = config.externalLiveBindings) !== null && _e !== void 0 ? _e : true,
        file,
        footer: getAddon(config, 'footer'),
        format,
        freeze: (_f = config.freeze) !== null && _f !== void 0 ? _f : true,
        generatedCode: getGeneratedCode(config, preferConst),
        globals: config.globals || {},
        hoistTransitiveImports: (_g = config.hoistTransitiveImports) !== null && _g !== void 0 ? _g : true,
